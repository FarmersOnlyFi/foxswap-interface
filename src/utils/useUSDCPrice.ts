...
export default function useUSDCPrice(currency?: Currency): Price | undefined {
  ...
  const tokenPairs: [Currency | undefined, Currency | undefined][] = useMemo(
    () => [
      ...
      [wrapped?.equals(USDC) ? undefined : wrapped, chainId === ChainId.HARMONY_MAINNET ? USDC : undefined],
      [chainId ? WETH[chainId] : undefined, chainId === ChainId.HARMONY_MAINNET ? USDC : undefined]
    ],

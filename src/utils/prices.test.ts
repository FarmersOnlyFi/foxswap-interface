import { ChainId, JSBI, Pair, Route, Token, TokenAmount, Trade, TradeType } from '@foxswap/sdk'
import { computeTradePriceBreakdown } from './prices'

describe('prices', () => {
  const token1 = new Token(ChainId.HARMONY_TESTNET, '0x0000000000000000000000000000000000000001', 18)
  const token2 = new Token(ChainId.HARMONY_TESTNET, '0x0000000000000000000000000000000000000002', 18)
  const token3 = new Token(ChainId.HARMONY_TESTNET, '0x0000000000000000000000000000000000000003', 18)

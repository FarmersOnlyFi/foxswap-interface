...
export const MERKLE_DISTRIBUTOR_ADDRESS: { [chainId in ChainId]?: string } = {
  [ChainId.HARMONY_MAINNET]: '0x090D4613473dEE047c3f2706764f49E0821D256e'
}
...
export const PINNED_PAIRS: { readonly [chainId in ChainId]?: [Token, Token][] } = {
  [ChainId.HARMONY_MAINNET]: [
    [getTokenWithDefault(ChainId.HARMONY_MAINNET, 'UST'), getTokenWithDefault(ChainId.HARMONY_MAINNET, '1USDC')]
  ]
}
